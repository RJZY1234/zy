         ...
         <ul class="navbar-nav">
           ...
           <li class="nav-item dropdown">
             ...
             <div class="dropdown-menu">
               ...
               <a class="dropdown-item" href="graderank.php">成绩统计</a>
             </div>
           </li>
           <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <table class="table table-hover">
                ...
                $sql="select Department, AVG(Chinese) as CJ,AVG(Math) as MJ,AVG(English) as EJ from grade group by Department";
                $result = $conn->query($sql);
                while ($data=mysqli_fetch_assoc($result)) {
                    $html = <<<A
            <tr>
                <td><output  name="Department">{$data["Department"]}</output></td>
